...
export default function Signup({ onLoginSuccess }) {
            ...
            callback: async (response) => {
              if (response && response.credential) {
                try {
                  ...
                  handleSignupSuccess(backendRes.data?.user, jwtToken);
                } catch (e) {
  ...
  const handleRealGoogleOAuth = () => {
    const clientId = import.meta.env.VITE_GOOGLE_CLIENT_ID;
    if (!clientId) {
      setError("Google Sign-Up is not configured. Please set VITE_GOOGLE_CLIENT_ID.");
      return;
    }
        ...
        <section className="auth-form-side">
          <div className="auth-form-wrapper">
            ...
            <div style={{ margin: "20px 0", textAlign: "center" }}>
              ...
              <div id="googleBtnContainerSignup" style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                <button
                  type="button"
