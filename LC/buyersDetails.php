    ...
    if (billsConfirmed($conn, $date) == 0) {
        ...
        if ($bagsSold) {
            ...
            if ($conn->query($sql1) === TRUE) {
                echo "<script>alert('saved successfully'); location.href='buyersDetails';</script>\n";
            }
        } else {
            echo "<script>alert('saved successfully'); location.href='buyersDetails';</script>\n";
        }
    } else {
        echo "<script>alert('Bills on that day are already finalized. You couldn't add new bill'); location.href='buyersDetails';</script>\n";
    }
}
?>
...
<html>
<head>
<title><?php echo $_SESSION["company"]; ?> - Buyers Details</title>
<script>
...
<ul>
  ...
  <li><a href="buyersDetails" class="active">Buyers Details</a></li>
...
<table class="tab">
<tr>
<th align="center" colspan="2">Buyers Details</th>
</tr>
<tr>
    <td>Date</td>
...
<tr>
    <td>Buyers Name</td>
    <td><input type="text" name="name" id="name" value="" placeholder="Buyers Name" required></td>
</tr>
